...
bedtools merge -i trim.xgen-exome-research-panel-targets.interval_list.bed > trim.xgen-exome-research-panel-targets.interval_list.merge.bed
...
## 取fasta
```
[zhangbo@cu-0036 bedtools]$ bedtools getfasta -fi fa.fa -bed fa.bed -fo xx.fa && cat xx.fa
index file fa.fa.fai not found, generating...
>chr1:0-5
AAAAC
>chr1:1-5
AAAC
[zhangbo@cu-0036 bedtools]$ cat fa.fa fa.bed
>chr1
AAAACCCCGGGTTTT
chr1    0       5
chr1    1       5
